...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference("Toy.count") do
      post toys_url, params: { toy: { age: @toy.age, condition: @toy.condition, description: @toy.description, price: @toy.price, title: @toy.title } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { age: @toy.age, condition: @toy.condition, description: @toy.description, price: @toy.price, title: @toy.title } }
